...
/**
 * @brief Subspace Iteration method for singular value decomposition
 * @details Computes singular values and vectors of a matrix using the Subspace Iteration method
